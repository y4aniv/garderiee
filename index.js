...
var ListeInscriptionGarderieXLSX = xlsx.parse(`${__dirname}/data/Liste complète garderie 2022-2023.xlsx`)[0].data
...
var ListeEleveTotalXLSX = xlsx.parse(`${__dirname}/data/Facture 6-8 ans modèle  BE 2022-2023.xlsx`)
var ListeEleveTotal = []
var InfoFacturation = {}
      ...
      if(j > 2){
        if(!isNaN(ListeEleveTotalXLSX[i].data[j][2])){
          var EleveInfo = {
            ...
            Prenom: ListeEleveTotalXLSX[i].data[j][3].split(",")[1],
